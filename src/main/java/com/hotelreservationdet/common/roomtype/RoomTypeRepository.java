...
import com.hotelreservationdet.common.jpa.Jpa8Repository;
...
public interface RoomTypeRepository extends Jpa8Repository<RoomType, Integer> {
    @Query(value = "SELECT new com.hotelreservationdet.common.roomtype.ReservedRoomType(r.roomTypeId, SUM(r.quantity)) " +
